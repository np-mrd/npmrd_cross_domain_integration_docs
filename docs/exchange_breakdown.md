...
- Target: NP-MRD Deposition System
- Response Type: [REPLACE_ME]
- Response Format: [REPLACE_ME]
...
## assignment_data <a name="nmr_data_assignment_data"></a>
  - assignment_uuid <a name="nmr_data_assignment_data_assignment_uuid"></a>
    - Description: uuid value unique to the provided assignment data. The same UUID is used for both the c list and h list.
